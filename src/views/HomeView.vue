...
<template>
  <div
    ...
    <div class="hidden lg:flex justify-center items-start relative bottom-30 text-tiny text-upright hide-under-1420">
      buffer
    </div>
    <div
    ...
    <span class="hidden md:flex md:justify-center text-tiny text-upright">image:repeating</span>
    ...
    <span class="hidden md:flex md:justify-center text-tiny text-upright">linear-gradient</span>
    <div
    ...
    <div class="hidden lg:flex justify-center relative bottom-30 items-end text-tiny text-upright hide-under-1420">
      buffer
    </div>
  </div>
</template>
