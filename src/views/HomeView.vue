...
<template>
  <div
    ...
    <div class="hidden lg:flex justify-center text-tiny text-upright">buffer1</div>
    <div
    ...
    <span class="hidden md:flex flex-center text-tiny text-upright">image:repeating</span>
    ...
    <span class="hidden md:flex flex-center text-tiny text-upright">linear-gradient</span>
    <div
    ...
    <div class="hidden lg:flex justify-center text-tiny text-upright">buffer2</div>
  </div>
</template>
